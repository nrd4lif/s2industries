...
export function FlaskIcon({ className = '', size = 24 }: IconProps) {
  return (
    ...
    >
      <path d="M9 3h6" />
      <path d="M10 3v6.5l-5 9.5h14l-5-9.5V3" />
      <path d="M7.5 15h9" />
    </svg>
  )
}
...
export function CardsIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ConstructionIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
